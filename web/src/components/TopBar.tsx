...
export function TopBar({ state, dispatch, send, theme, setTheme }: { state: DashboardState; dispatch: React.Dispatch<DashboardAction>; send: WsSendFn; theme: Theme; setTheme: (t: Theme) => void }) {
  const cycleTheme = () => {
